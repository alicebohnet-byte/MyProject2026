#Code 2 : ecosystem (for my 5 species)
...
#rds from the "allmatrixfulltogether" code
matrix_full <- readRDS("matrix_full.rds")
...
#new data frame with my matrix full and the ecovalues
...
#to use it later
saveRDS(matrix_full_eco, file = "matrix_full_eco.rds")
...
#Create a bar plot showing how many observations of each species are found in each climate category
